...
//debugger;
        ...
        this._elem.ondragenter = (event: Event) => {
             console.log('abstract : elem.ondragenter', this._isDropAllowed);
            this._onDragEnter(event);
        };
        this._elem.ondragover = (event: DragEvent) => {
             console.log('abstract : elem.ondragover', this._isDropAllowed);
        ...
        this._elem.ondragstart = (event: DragEvent) => {
           console.log('abstract : elem.ondragstart'+ this._dragEnabled+" this._elem.draggable "+this._elem.draggable);
          // debugger;
